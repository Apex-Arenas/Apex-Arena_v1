...
const TYPE_META: Record<string, { icon: React.ElementType; color: string; bar: string; bg: string }> = {
  tournament_registration:  { icon: Trophy,      color: "text-cyan-400",   bar: "bg-cyan-400",   bg: "bg-cyan-500/10"   },
  tournament_cancelled:     { icon: Trophy,      color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  tournament_started:       { icon: Trophy,      color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  tournament_completed:     { icon: Trophy,      color: "text-amber-400",  bar: "bg-amber-400",  bg: "bg-amber-500/10"  },
  tournament_open:          { icon: Trophy,      color: "text-cyan-400",   bar: "bg-cyan-400",   bg: "bg-cyan-500/10"   },
  match_scheduled:          { icon: Swords,      color: "text-indigo-400", bar: "bg-indigo-400", bg: "bg-indigo-500/10" },
  match_starting:           { icon: Swords,      color: "text-orange-400", bar: "bg-orange-400", bg: "bg-orange-500/10" },
  match_result_submitted:   { icon: Swords,      color: "text-slate-400",  bar: "bg-slate-500",  bg: "bg-slate-700/40"  },
  match_disputed:           { icon: ShieldAlert, color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  match_dispute_resolved:   { icon: ShieldAlert, color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  match_result_confirmed:   { icon: Check,       color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  match_forfeit:            { icon: Swords,      color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  prize_won:                { icon: Star,        color: "text-amber-400",  bar: "bg-amber-400",  bg: "bg-amber-500/10"  },
  prize_credited:           { icon: Star,        color: "text-amber-400",  bar: "bg-amber-400",  bg: "bg-amber-500/10"  },
  payout_completed:         { icon: Wallet,      color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  payout_failed:            { icon: Wallet,      color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  payout_requested:         { icon: Wallet,      color: "text-cyan-400",   bar: "bg-cyan-400",   bg: "bg-cyan-500/10"   },
  deposit_confirmed:        { icon: Wallet,      color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  refund_processed:         { icon: Wallet,      color: "text-blue-400",   bar: "bg-blue-400",   bg: "bg-blue-500/10"   },
  new_device_login:         { icon: ShieldAlert, color: "text-orange-400", bar: "bg-orange-400", bg: "bg-orange-500/10" },
  password_changed:         { icon: ShieldAlert, color: "text-orange-400", bar: "bg-orange-400", bg: "bg-orange-500/10" },
  two_fa_enabled:           { icon: ShieldAlert, color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  two_fa_disabled:          { icon: ShieldAlert, color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  account_unbanned:         { icon: UserCheck,   color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  organizer_approved:       { icon: UserCheck,   color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  organizer_rejected:       { icon: UserCheck,   color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
  team_invite:              { icon: Users,       color: "text-indigo-400", bar: "bg-indigo-400", bg: "bg-indigo-500/10" },
  new_follower:             { icon: Users,       color: "text-cyan-400",   bar: "bg-cyan-400",   bg: "bg-cyan-500/10"   },
  game_request_approved:    { icon: Zap,         color: "text-green-400",  bar: "bg-green-400",  bg: "bg-green-500/10"  },
  game_request_rejected:    { icon: Zap,         color: "text-red-400",    bar: "bg-red-400",    bg: "bg-red-500/10"    },
};
...
function inferBarFromType(type: string): { icon: React.ElementType; color: string; bar: string; bg: string } {
  ...
  if (t.includes("tournament") || t.includes("register") || t.includes("publish") || t.includes("open"))
    return { icon: Trophy,      color: "text-cyan-400",   bar: "bg-cyan-400",   bg: "bg-cyan-500/10"   };
