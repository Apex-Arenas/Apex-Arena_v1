          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <section className="rounded-2xl border border-slate-800 bg-slate-900/60 overflow-hidden">
              <div className="px-5 py-3 border-b border-slate-800 flex items-center gap-2">
                ...
                <h2 className="font-display text-sm font-bold text-white">Schedule</h2>
              </div>
              <div className="grid grid-cols-2 gap-px bg-slate-800/60 p-px">
                {[
                  { label: "Reg. Opens",    value: tournament.schedule.registrationStart,            dot: "bg-emerald-400" },
                  { label: "Reg. Closes",   value: tournament.schedule.registrationEnd,              dot: "bg-red-400"     },
                  { label: "Starts",        value: tournament.schedule.tournamentStart,              dot: "bg-orange-400"  },
                  { label: "Ends",          value: tournament.schedule.tournamentEnd,                dot: "bg-slate-400"   },
